...
|--------|--------------|-----------------|-----|
| Fig 1a | Pan-cancer alteration frequency (top genes) | OncoPrint | [Open](https://www.cbioportal.org/results/oncoprint?cancer_study_list=msk_impact_2017&gene_list=TP53+KRAS+PIK3CA+PTEN+APC+EGFR+BRAF+CDKN2A+RB1+ERBB2&case_set_id=msk_impact_2017_all) |
| Fig 1b | Cancer type distribution of cohort | Study View summary | [Open](https://www.cbioportal.org/study?id=msk_impact_2017) |
| Fig 2a | TERT promoter mutation prevalence by cancer type | Cancer Types Summary | [Open](https://www.cbioportal.org/results/cancerTypesSummary?cancer_study_list=msk_impact_2017&gene_list=TERT&case_set_id=msk_impact_2017_all) |
| Fig 2b | TERT survival association (altered vs unaltered) | Comparison → Survival | [Open](https://www.cbioportal.org/results/comparison/survival?cancer_study_list=msk_impact_2017&gene_list=TERT&case_set_id=msk_impact_2017_all) |
| Fig 3b | Kinase fusion landscape by cancer type | Structural Variants | [Open](https://www.cbioportal.org/results/structuralVariants?cancer_study_list=msk_impact_2017&gene_list=ALK+RET+ROS1+BRAF+NTRK1+NTRK2+NTRK3+MET+FGFR1+FGFR2+FGFR3&case_set_id=msk_impact_2017_all) |
| Fig 4a | TMB distribution by cancer type | Study View → Plots | [Open](https://www.cbioportal.org/study/plots?id=msk_impact_2017&plots_horz_selection=%7B%22dataType%22%3A%22clinical_attribute%22%2C%22selectedDataSourceOption%22%3A%22CANCER_TYPE_DETAILED%22%7D&plots_vert_selection=%7B%22dataType%22%3A%22clinical_attribute%22%2C%22selectedDataSourceOption%22%3A%22TMB_NONSYNONYMOUS%22%7D) |
| Fig 4b | KRAS mutual exclusivity with other RAS pathway genes | Mutual Exclusivity | [Open](https://www.cbioportal.org/results/mutualExclusivity?cancer_study_list=msk_impact_2017&gene_list=KRAS+BRAF+NRAS+HRAS+NF1&case_set_id=msk_impact_2017_all) |

_URLs generated via [cBioPortal Navigator MCP](https://mcp.cbioportal.org/navigator/mcp)._
