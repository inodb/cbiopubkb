...
| Figure | What it shows | cBioPortal view | Instructions |
|--------|--------------|-----------------|--------------|
| Fig 1a | Pan-cancer alteration frequency by gene | OncoPrint (ResultsView) | [Open OncoPrint](https://www.cbioportal.org/results/oncoprint?study_id=msk_impact_2017&gene_list=TP53%20KRAS%20PIK3CA%20PTEN%20APC%20EGFR%20BRAF%20CDKN2A&profileFilter=mutations%2Ccna) |
| Fig 1b | Cancer type breakdown of cohort | Study View summary | [Open Study View](https://www.cbioportal.org/study?id=msk_impact_2017) → Cancer Type chart |
| Fig 2a | TERT promoter mutation prevalence by cancer type | Cancer Types Summary | ResultsView → Cancer Types Summary tab, gene=TERT |
| Fig 2b | TERT survival association | Survival (ResultsView) | ResultsView → Comparison → Survival, gene=TERT, altered vs unaltered |
| Fig 3b | Kinase fusion landscape by cancer type | Structural Variants tab | ResultsView → Structural Variants, genes=ALK,RET,ROS1,BRAF,NTRK1,NTRK2,NTRK3 |
| Fig 4a | TMB distribution by cancer type | Study View plots | Study View → Plots: X=Cancer Type Detailed, Y=TMB_NONSYNONYMOUS |
| Fig 5 | Actionable alteration rates by cancer type | Cancer Types Summary | ResultsView → Cancer Types Summary, OncoKB filter in Study View |
